...
import ".pages/HomePage.css"; // Ensure this file exists and contains your styles
  ...
  return (
    <>
      ...
      <main className="page-container">
        <h2>Contact Us</h2>
        <p>
          If you have any questions, inquiries, or feedback, feel free to reach
          out to us using the form below or through our contact details.
        </p>

        <section className="contact-form">
          <form
            action="mailto:ask@gbtsbuildingmaterials.com"
            method="post"
            encType="text/plain"
          >
        ...
        <section className="contact-info">
          ...
          <p>
            <strong>Address:</strong> Shop 1, Jubilee market, Ikare Akoko
            342211, Ondo State, Nigeria
          </p>
          <p>
            <strong>Email:</strong>{" "}
