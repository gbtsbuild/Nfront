    ...
    <Router>
      <nav>
        <ul>
          ...
          <li><Link to="/roofings">Roofings</Link></li>
          <li><Link to="/hand-tools">Hand Tools</Link></li>
          <li><Link to="/locks-knobs">Locks & Knobs</Link></li>
          <li><Link to="/security-cameras">Security Cameras</Link></li>
